...
// Edited by Gzh: emit -> emit_texture
class diffuse_light : public material {
    public:
        diffuse_light(shared_ptr<texture> a) : emit_texture(a) {}
        diffuse_light(color c) : emit_texture(make_shared<solid_color>(c)) {}
    ...
    public:
        shared_ptr<texture> emit_texture;
};
